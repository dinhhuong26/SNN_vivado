...
HD_PWD='D:/DO_AN_TOT_NGHIEP/Synap_connection/Synap_connection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synap_connection.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synap_connection.tcl
