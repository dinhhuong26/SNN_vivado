...
set_property PACKAGE_PIN AB8 [get_ports connection_valid_0]
#set_property PACKAGE_PIN AA8 [get_ports new_potential_o_0[1]]
#set_property PACKAGE_PIN AC9 [get_ports new_potential_o_0[2]]
#set_property PACKAGE_PIN AB9 [get_ports new_potential_o_0[3]]
#set_property PACKAGE_PIN AE26 [get_ports new_potential_o_0[4]]
#set_property PACKAGE_PIN G19 [get_ports new_potential_o_0[5]]
#set_property PACKAGE_PIN E18 [get_ports new_potential_o_0[6]]
#set_property PACKAGE_PIN F16 [get_ports new_potential_o_0[7]]

set_property IOSTANDARD LVCMOS15 [get_ports {connection_valid_0}]
#set_property IOSTANDARD LVCMOS15 [get_ports {new_potential_o_0[1]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {new_potential_o_0[2]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {new_potential_o_0[3]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {new_potential_o_0[4]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {new_potential_o_0[5]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {new_potential_o_0[6]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {new_potential_o_0[7]}]
...
# BUTTON
#set_property PACKAGE_PIN AA12 [get_ports process_spike_0]
#set_property PACKAGE_PIN AB12 [get_ports reset_n_0]
#set_property PACKAGE_PIN AC6  [get_ports wen_0]
#set_property PACKAGE_PIN AG5  [get_ports voltage_potential_i[3]]
#set_property PACKAGE_PIN G12  [get_ports voltage_potential_i[4]]

#set_property IOSTANDARD LVCMOS15 [get_ports process_spike_0]
#set_property IOSTANDARD LVCMOS15 [get_ports reset_n_0]
#set_property IOSTANDARD LVCMOS15 [get_ports wen_0]
#set_property IOSTANDARD LVCMOS15 [get_ports voltage_potential_i[3]]
#set_property IOSTANDARD LVCMOS25 [get_ports voltage_potential_i[4]]

# DIP SW
#set_property PACKAGE_PIN Y28  [get_ports voltage_potential_i[0]]
#set_property PACKAGE_PIN AA28 [get_ports voltage_potential_i[0]]
#set_property PACKAGE_PIN W29  [get_ports voltage_potential_i[0]]
#set_property PACKAGE_PIN Y29  [get_ports voltage_potential_i[0]]

#set_property IOSTANDARD LVCMOS25 [get_ports voltage_potential_i[0]]
#set_property IOSTANDARD LVCMOS25 [get_ports voltage_potential_i[0]]
#set_property IOSTANDARD LVCMOS25 [get_ports voltage_potential_i[0]]
#set_property IOSTANDARD LVCMOS25 [get_ports voltage_potential_i[0]]
...
#set_property PACKAGE_PIN F21 [get_ports spike_o_0]
#set_property IOSTANDARD LVCMOS25 [get_ports spike_o_0]
#GBTCLK0_FSEL0
#set_property PACKAGE_PIN H24 [get_ports {neuron_number_valid}]
#set_property IOSTANDARD LVCMOS25 [get_ports {neuron_number_valid}]
#GBTCLK0_FSEL1
...
#set_property PACKAGE_PIN E21 [get_ports clk_0]
#set_property IOSTANDARD LVCMOS25 [get_ports clk_0]

#create_clock -period 5.000 -name clk_0 [get_ports clk_0]

#set_property IOSTANDARD DIFF_SSTL15 [get_ports clk_0]

#set_property IOSTANDARD DIFF_SSTL15 [get_ports clk200_p]
set_property PACKAGE_PIN AD12 [get_ports clk_0]
